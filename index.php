...
<html>
    ...
    <body>
        ...
        <script>
            const parallax = document.querySelector('#xp-para');
            ...
            window.addEventListener('scroll', () =>
              {
                ...
                if (window.innerWidth > 1170){
                    parallax.style.backgroundPositionY = - 900 + window.scrollY / 2 + "px";
                }
                else if (window.innerWidth <= 1170)
                {
                    parallax.style.backgroundPositionY = - 900 + window.scrollY / 4 + "px";
                }
              });
        </script>
        ...
        <section id="skills" class="clear">
            ...
            <div class="content-center space">
                ...
                <div data-aos="fade-up" data-aos-easing="linear" data-aos-duration="1500">
                        ...
                        <p class="align left float left">HTML / CSS / Bootstrap</p><p id="percent1" class="align right float right">0%</p>
                        <div class="progressBar float left"><div id="progress_bar_html"></div></div>
                        
                        <p class="align left float left">MySQL</p><p id="percent2" class="align right float right">0%</p>
                        <div class="progressBar float left"><div id="progress_bar_php"></div></div>
                 
                        <p class="align left float left">JavaScript / jQuery</p><p id="percent3" class="align right float right">0%</p>
                        <div class="progressBar float left"><div id="progress_bar_js"></div></div>
                        
                        <p class="align left float left">PHP / WordPress / Symfony</p><p id="percent4" class="align right float right">0%</p>
        ...
        <section id="contact" class="clear space">
            <div align="center">
                <h2 data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500">Contact</h2>
                <p style="color: #010423;">
                    TEL : 06 72 26 15 16<br>
            ...
            <form action="post_contact.php" method="POST">
                <div>
                    <input required class="name" type="text" name="name" placeholder="Name" value="<?= isset($_SESSION['inputs']['name']) ? $_SESSION['inputs']['name'] : '';?>">
                    <input required class="email" type="email" name="email" placeholder="E-mail" <?= isset($_SESSION['inputs']['email']) ? $_SESSION['inputs']['email'] : '';?>>
                </div>
                <div>
                    <div>
                        <textarea required class="message" type="text" name="message" placeholder="Message"><?= isset($_SESSION['inputs']['message']) ? $_SESSION['inputs']['message'] : '';?></textarea>
                    </div>
                </div>
    ...
    <footer style="background-color: #f2f2f2; padding: 20px 60px;">
        <div class="content-center">
            <div class="align center">
                <p style="font-size: 13px; color: #a6a6a6;">Copyright © 2019 design by <a href="https://www.benjamin-benaicha.com" style="color: #a6a6a6;">Benjamin Benaicha</a> Code by <a href="https://www.benjamin-benaicha.com" style="color: #a6a6a6;">Jermie Benaicha</a>. All rights reserved.   |    <a href="mailto:benjamin.benaicha@gmail.com" style="color: #a6a6a6;">Contact Us</a></p>
            </div>
        </div>    
    </footer>
</html>